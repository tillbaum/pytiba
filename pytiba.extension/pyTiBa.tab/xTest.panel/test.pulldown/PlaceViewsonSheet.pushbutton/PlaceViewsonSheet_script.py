...
sheetview = list()
viewlist = list()
[viewlist.append(i) if i.Category.Name.Equals("Views") else sheetview.append(i) 
                    if i.Category.Name.Equals("Sheets") else False
                    for i in secviewlist]


if not viewlist:
    forms.alert("Select Views and 1 Sheet in the Project Browser\nExiting...", ok= True)
    sys.exit()
