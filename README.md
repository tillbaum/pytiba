...
[![GitHub license](https://img.shields.io/badge/License-MIT-brightgreen.svg)](https://github.com/tillbaum/pytiba/blob/master/LICENSE)
...
(Left Click on Button > Add to Quick launch Toolbar)
