...
#Grab TitleBlock of Sheet!  C# Code!!
# //Find titleblock of the newly created sheet.
currentview = uidoc.ActiveView
FECtibl = FilteredElementCollector(doc).OfCategory(BuiltInCategory.OST_TitleBlocks) \
                .OwnedByView(currentview.Id) \
                .FirstElement()


# <Autodesk.Revit.DB.FamilyInstance object at 0x000000000000042D [Autodesk.Revit.DB.FamilyInstance]>
# >>> FECtibl.Name
# ﻿'Variabel'
