...
filterpar = DB.ElementId(DB.BuiltInParameter.VIS_GRAPHICS_FILTERS)

list2var(templateviews, "v")
noncon = v0.GetNonControlledTemplateParameterIds()
...
for view in templateviews: 
    ...
    try:
        noncontroledparaList.Add(filterpar.Id) 
