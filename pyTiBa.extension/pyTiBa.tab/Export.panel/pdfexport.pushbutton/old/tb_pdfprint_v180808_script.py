...
PDFsOut: 
    ...
    v2.3 21.09.2018; !Temp PrintSetting: FitToPage is set; added        
        .ZoomType = ZoomType.Zoom #Enum´    
"""
...
# When I set a Variable TitleBlock manually to 1189x841  int(FEC...) returns 1189 ,841. --> works. 
# If you check the dimensions in the family
# everything has the right size: width = 1189.00
...
def printview(singlesheet, filepathname , papersizeobj, pdfprinterName,
    ...
    page_orient = DB.PageOrientationType.Portrait # enum 
    _printsetup.CurrentPrintSetting.PrintParameters.ZoomType = ZoomType.Zoom # enum
